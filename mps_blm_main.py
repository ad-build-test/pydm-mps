...
class mps_blm_main(Display):
  def __init__(self, parent=None, args=None, macros=None):
    ...
    PV = "ca://{P}:LC1_ANA_PK_DEL_TRG_{CH}_RBV".format(**macros)
    ...
    PV = "ca://{P}:LC1_ANA_PK_WDT_TRG_{CH}_RBV".format(**macros)
    ...
    PV = "ca://{P}:LC1_ANA_PD_DEL_TRG_{CH}_RBV".format(**macros)
    ...
    PV = "ca://{P}:LC1_ANA_PD_WDT_TRG_{CH}_RBV".format(**macros)
